...
CREATE UNIQUE INDEX "search_docs_user_entity_idx" ON "search_documents" USING btree ("user_id","entity_type","entity_id");--> statement-breakpoint
CREATE INDEX "search_docs_user_updated_idx" ON "search_documents" USING btree ("user_id","updated_at" DESC NULLS LAST);