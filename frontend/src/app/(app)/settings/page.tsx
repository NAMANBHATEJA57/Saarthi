    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-2xl mx-auto">
      ...
      <div className="space-y-4 bg-[hsl(var(--surface))] p-5 rounded-lg border border-[hsl(var(--hairline))]">
        ...
        <p className="text-xs text-[hsl(var(--ink-secondary))]">
          Connect external services like Google Calendar to sync your tasks and events.
        </p>
        <a
          href="/settings/calendar"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-[hsl(var(--canvas))] border border-[hsl(var(--hairline))] text-sm font-medium hover:bg-[hsl(var(--surface-elevated))] transition-colors"
        >
